...
class Index:
    ...
    def get_historical_data(self, start_date: Date, end_date: Optional[Date] = None) -> pd.DataFrame:
        ...
        self.data = data.reindex(pd.date_range(min_available, max_available)).interpolate(method="linear")
